...
function Main() {
  ...
  return (
    <div className="flex">
      ...
      <nav
        className={clsx([
          "absolute z-[9999] xl:z-[9999] -ml-[100%] xl:ml-0 transition-[width,margin-left] w-[270px] h-screen flex flex-col pl-6 pr-2 overflow-hidden bg-primary bg-gradient-to-b from-primary via-primary/70 to-black/30 duration-300 ease-in-out dark:bg-darkmode-800 dark:bg-none",
      ...
      >
        ...
        <div
          className={clsx([
            "mt-[1.2rem] rounded-[1rem] w-full min-h-screen relative bg-slate-100 px-4 sm:px-6 pt-0.5 pb-6 dark:bg-darkmode-700",
          ])}
        >
          <Outlet />
        </div>
