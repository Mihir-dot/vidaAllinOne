...
function Main(props: { toggleMobileMenu: (event: React.MouseEvent) => void }) {
  ...
  const logout = async () => {
    ...
    //   toast.error(toastMsg || "Token expired or invalid");
    // } else {
    //   toast.success(toastMsg || "logout successfully");
    // }
  };
  ...
  return (
    <>
      {/* BEGIN: Top Bar */}
      <div className="h-[63px] z-[51] flex items-center justify-between relative px-5">
        {/* BEGIN: Breadcrumb */}
          ...
          <Menu.Button className="flex items-center h-full dropdown-toggle">
            ...
            <div className="hidden ml-3 md:block text-slate-200">
              <div className="flex items-center gap-1">
                <div className="max-w-[7rem] font-medium">
                  Bhavisha
                  {/* {userName ? userName : ""} */}
                </div>
                <div>
